...
#define SDK_BVER 4  /*sdk branch version*/
...
#define VERSION_STR "\r\n** hgSDK-v"_V_S2_(SDK_MVER)"."_V_S2_(SDK_BVER)"."_V_S2_(SDK_PVER)"."_V_S2_(PROJECT_TYPE)"-"_V_S2_(SVN_VERSION)", app-"_V_S2_(APP_VERSION)", build time:"__DATE__" "__TIME__" **\r\n"
