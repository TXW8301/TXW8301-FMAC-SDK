...
#define pmu_get_boot_direct_run_pending()       ((PWRDMCTL->CORE_PMUCON7 & BIT(0)))
#define pmu_get_boot_direct_run_pending2()      ((PWRDMCTL->CORE_PMUCON7 & BIT(23)))
#define pmu_set_direct_run_pengding2()          do { CORE_SEC_OPT(PMUCON7, PWRDMCTL->CORE_PMUCON7 | BIT(23)); } while(0)
#define pmu_clr_direct_run_pengding2()          do { CORE_SEC_OPT(PMUCON7, PWRDMCTL->CORE_PMUCON7 & ~(BIT(23))); } while(0)
...
__STATIC_INLINE void core_sec_opt_func(uint32 a, uint32 b){
...
uint32 sysctrl_efuse_get_saw_info(void);
...
uint8 sysctrl_efuse_get_sip_ind(void);
...
uint8 sysctrl_efuse_get_rx_conv_gain(uint8 freq_idx);
...
#define MODULE_TYPE_900M_GC0658 6
...
int8 sysctrl_freq_type_match(uint32 freq);
