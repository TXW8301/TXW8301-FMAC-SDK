...
int32 wificfg_set_wpa_psk(uint8 *key);
...
int32 wificfg_get_wpa_psk(uint8 psk[32]);
...
int32 wificfg_set_heartbeat_int(uint32 heartbeat_int);
...
int32 wificfg_set_auto_save(uint8 off);
...
int32 wificfg_set_mcast_txparam(uint8 *data);
...
int32 wificfg_set_wkupdata_mask(uint8 offset, uint8 *mask, uint32 mask_len);

int32 wificfg_set_wakeup_data(uint8 *data, uint32 data_len);

int32 wificfg_set_wkdata_svr_ip(uint32 svr_ip);

int32 wificfg_set_passwd(uint8 *passwd);
