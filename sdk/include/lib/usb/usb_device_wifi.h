...
extern int32 usb_device_wifi_write(struct usb_device *p_usb_d, uint8 *buff, uint32 len);
extern int32 usb_device_wifi_read(struct usb_device *p_usb_d, uint8 *buff, uint32 len);
extern int32 usb_device_wifi_write_scatter(struct usb_device *p_usb_d, scatter_data *data, int count);
