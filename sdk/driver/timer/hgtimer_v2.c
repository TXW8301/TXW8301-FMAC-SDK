...
static const struct timer_hal_ops timer_v2_ops = {
    .open     = hgtimer_v2_open,
    .close    = hgtimer_v2_close,
    .start    = hgtimer_v2_start,
    .stop     = hgtimer_v2_stop,
    .ioctl    = hgtimer_v2_ioctl,
};
...
__init int32 hgtimer_v2_attach(uint32 dev_id, struct hgtimer_v2 *timer)
{
    ...
    timer->dev.dev.ops  = (const struct devobj_ops *)&timer_v2_ops;
